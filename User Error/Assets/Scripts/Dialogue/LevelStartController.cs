...
public class NewMonoBehaviourScript : MonoBehaviour
{
    ...
    IEnumerator CompleteStartSequence()
    {
        ...
        "Я прямо сейчас соберу для тебя уровень! Здесь, на лету!", "Ой, только давай сначала пройдём обучение! Чтобы ты привык к управлению.","Я его быстренько слепила из того, что под руку попало, так что текстурки там... ну, ты поймёшь. Зато потом будет всё красиво, обещаю!","Не бойся, если что-то будет слегка... не так. Мои процедуры слегка зациклились от бездействия, но всё под контролем! Готов?", "Отлично! Поехали!"};
